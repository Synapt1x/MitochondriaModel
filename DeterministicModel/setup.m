...
[parameters.title{1:6}] = deal(['Cyt c Reduced Concentration Over'...
    ' Time'],'Oxygen Concentration Over Time', ...
    'OCR Over Time', ...
    'Matrix Proton concentration Over Time',...
    'IMS Proton concentration Over Time',...
    'Matrix to IMS Proton Ratio Over Time');
[parameters.ylab{1:6}] = deal('Cyt c_{red} (nmol/mL)', ...
    'O_2 (nmol/mL)','OCR (nmol/mL*sec)','H_N (nmol/mL)', ...
    'H_P (nmol/mL)','Proton Ratio');
