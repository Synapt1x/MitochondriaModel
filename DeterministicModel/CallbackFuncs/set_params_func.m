...
if ~isempty(varargin)
    [params.fIV_Vmax, params.fIV_K, params.fIV_Km, params.fV_Vmax, ...
        params.fV_K, params.fV_Km, params.f0_Vmax, params.f0_Km, params.p_alpha,...
        params.p_fccp, params.cytcred, params.cytcox, params.amp_1, ...
        params.amp_2, params.amp_3, params.amp_4, params.cyt_c_drop] = deal(values(1), ...
