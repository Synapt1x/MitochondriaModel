...
% ====================================
% Parameters (X)
par.X.Vmax.range=[1,1E3];
%
par.X.K1.range=[1,1E3];
%
par.X.Km.range=[1,1E3];
%
par.X.p1.range=[1,1E2];
%
par.X.p2.range=[100,5E3];
%
par.X.p3.range=[1e-6,1e-4];
%
par.X.f0.range=[1,1E2];
%
par.X.Dh.range=[1e-7,1e-5];
%
% ====================================
% Parallel Computing
