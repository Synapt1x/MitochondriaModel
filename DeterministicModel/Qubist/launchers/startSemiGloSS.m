...
otherWindows={'FerretConsoleWindow', 'AnvilConsoleWindow',...
    'LocustConsoleWindow', 'SAMOSA_consoleWindow'};
...
try %#ok
    QV=Qubist_Version;
    disp(['Starting SemiGloSS ', QV.SemiGloSS, '.'])
end
