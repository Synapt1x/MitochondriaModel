...
function par=defaultSemiGloSS_setup
% Sets reasonable defaults for parameters where possible.
% Values are over-ridden by FerretSetup.m or SemiGloSS_setup.
% ====================================
% Mode
...
% par.user.extPar=[]; % [string]: *** This line should be in the default
% setup file, but NOT the problem's setup file! ***
% ====================================
% General
