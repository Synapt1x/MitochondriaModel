...
%
% *** TO ALLOW ZOON-OUT ***
par.general.softMin=[1, 2]; % [integer vector >= 1]: Which parameters have soft minimum bounds?
par.general.softMax=[1, 2]; % [integer vector >= 1]: Which parameters have soft maximum bounds?
% ====================================
% Selection
