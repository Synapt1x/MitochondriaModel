...
% ====================================
% General
par.general.min=-600+zeros(1,par.user.extPar.n);
par.general.max=600+zeros(1,par.user.extPar.n);
...
par.mutation.PSuperMutate=0.05;
...
% ====================================
% Linkage Learning
% !!!!! NOTE THE UNUSUAL LINKAGE SETTING !!!!!
% This problem is really fully linked, but this setting improves the
% optimization significantly due to the symmetry of the problem.
par.link.PLink=1e-10;
par.link.initialLinkage=0;
% ====================================
% Zooming
par.zoom.NGen=25;
par.zoom.safety=1;
