...
% ====================================
% Immigration
par.immigration.PImmigrate=0.005; % <-- Keep small for this problem so that populations spready out in the valley.
% ====================================
% Elitism
