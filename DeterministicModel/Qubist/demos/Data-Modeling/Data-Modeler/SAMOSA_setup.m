...
par.simplex.contractFactor=0.5; % [0 - 1] % Factor to contract by on contraction steps.
par.simplex.expandFactor=2; % [real > 1]: % Factor to expand by on expansion steps.
par.simplex.PKick=0.05; % [real > 1]: % Probability of a mutation-like kick.  Improves exploration.
% ====================================
% Stopping
...
% ====================================
% Graphics & messages
par.interface.verbose=1; % [logical]: Verbose output?
