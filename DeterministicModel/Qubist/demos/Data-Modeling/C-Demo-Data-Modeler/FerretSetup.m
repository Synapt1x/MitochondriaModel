...
% ====================================
% User
par.user.fitnessFcn='CFitnessWrapper'; % <-- *** NOTE THAT THIS IS AN M-FILE WRAPPER FOR THE C FUNCTION! ***
% ====================================
% Data
...
par.parallel.timeout=30000; % Maximum time in seconds before an unresponsive node disconnects.
