...
% ====================================
% General
n=par.user.extPar.n; % Dimensionality of the Rastrigin function.  Coded in init.m.
par.general.min=-2.5+zeros(1,n);
par.general.max=2.5+zeros(1,n);
...
par.selection.FAbsTol=0.25;
par.selection.PPreferSuperiorMates=0; % [0 - 1]: Sexual selection: probability that individuals prefer superior mates during XOver.
% ====================================
% Niching
par.niching.X=0.3;
% ====================================
