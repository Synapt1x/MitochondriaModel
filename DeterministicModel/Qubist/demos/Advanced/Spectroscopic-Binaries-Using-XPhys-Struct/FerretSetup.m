...
% ====================================
% General
par.general.XLabels={'\phi', 'sin i', 'eccentricity', 'm1', 'm2', 'a'};
par.general.NPop=2;
...
% ====================================
% Parameters (X)
par.X.phi.range=[0, 360];
par.X.phi.cyclic=true;
%
par.X.sini.range=[0,1];
par.X.e.range=[0,0.9];
%
par.X.m1.range=[0.1,10];
par.X.m1.logDynRange=2;
%
par.X.m2.range=[0.1,10];
par.X.m2.logDynRange=NaN;
%
par.X.a.range=[0.1,10];
par.X.a.logDynRange=true;
%
% ====================================
% Selection
