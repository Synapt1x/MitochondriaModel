...
% ====================================
% User
par.user.fitnessFcn='fitnessInternal'; % [string]: Name of the fitness function.
par.user.output=''; % [string]: Name of optional user-defined output function called each move.
% ====================================
% General
par.general.min=zeros(1,NPar.SAMOSA);
par.general.max=ones(1,NPar.SAMOSA);
par.general.FAbsTol=0; % [real > 0]: Absolute tolerance on fitness values.
% ====================================
% Simplex
...
% ====================================
% Stopping
par.stopping.maxNMoves=10; % [integer > 0]: Maximum number of simplex moves.
...
% ====================================
% Graphics & messages
par.interface.verbose=0; % [integer: -1, 0, 1, or 2]: Verbose output?
