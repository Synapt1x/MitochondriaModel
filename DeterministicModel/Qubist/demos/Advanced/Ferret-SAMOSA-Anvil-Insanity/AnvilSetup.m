...
% ====================================
% User
par.user.fitnessFcn='fitnessInternal'; % Name of the fitness function.
...
% Stopping criteria
%
% Maximum number of steps with no improvement.
par.stopping.maxItNoImprovement=25; % [integer]
%
...
par.stopping.maxNOptimals=500; % [integer]: Max number of optimals.
% ====================================
% Niching
