...
% ============================================
% General
par.general.min=1e-3+zeros(1,par.user.extPar.N);
par.general.max=ones(1,par.user.extPar.N);
% ====================================
% Parallel Computing
...
par.swarm.PKick=0.05; % [real << 1]: Probability of perturbing swarm with a random `kick'.
...
par.stopping.FTol=NaN; % [real]: Tolerance in fitness.
