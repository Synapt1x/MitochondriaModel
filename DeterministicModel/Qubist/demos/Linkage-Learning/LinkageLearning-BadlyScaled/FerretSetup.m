...
% to zero, or smaller than the smallest building block fitness scale in the problem.
par.link.FAbsTol=0; % Absolute fitness range (+/- FAbsTol) to use as a fuzzy fitness band.
...
par.zoom.NGen=100; % [integer >= 1]: Zoom control.
