...
dy(3) = -6*((params.f0_Vmax*(cytcdiff))/(params.f0_Km+(cytcdiff))) ...
        *(Hn./Hp) - 4*((params.fIV_Vmax*O2)/(params.fIV_Km*(1 ...
        +(params.fIV_K/cytcred))+O2))*(Hn/Hp) + (0.25*heaviside(t - params.fccp_25_t) ...
        + 0.25*heaviside(t - params.fccp_50_t) + 0.25*heaviside(t - params.fccp_75_t) ...
        + 0.25*heaviside(t - params.fccp_100_t)) * params.Dh * ((Hp - Hn) + Hp * log(Hp/Hn));%dHn
dy(4) = 8*((params.f0_Vmax*(cytcdiff))/(params.f0_Km+(cytcdiff))) ...
        *(Hn./Hp) + 2*((params.fIV_Vmax*O2)/(params.fIV_Km*(1 ...
        +(params.fIV_K/cytcred))+O2))*(Hn/Hp) - (0.25*heaviside(t - params.fccp_25_t) ...
        + 0.25*heaviside(t - params.fccp_50_t) + 0.25*heaviside(t - params.fccp_75_t) ...
        + 0.25*heaviside(t - params.fccp_100_t)) * params.Dh * ((Hp - Hn) + Hp * log(Hp/Hn)); %dHp
