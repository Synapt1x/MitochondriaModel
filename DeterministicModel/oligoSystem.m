...
dy(3) = -6*((params.f0_Vmax*(cytcdiff))/(params.f0_Km+(cytcdiff))) ...
        *(Hn./Hp) - 4*((params.fIV_Vmax*O2)/(params.fIV_Km*(1 ...
        ...
        + (0.25*(e^(-params.alpha*(t - params.fccp_25_t))) ...
        + 0.25*(e^(-params.alpha*(t - params.fccp_50_t))) ...
        + 0.25*(e^(-params.alpha*(t - params.fccp_75_t))) ...
        + 0.25*(e^(-params.alpha*(t - params.fccp_100_t)))) ...
