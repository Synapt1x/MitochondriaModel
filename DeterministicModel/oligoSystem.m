...
dy(3) = -6*((params.f0Vmax*(cytcdiff))/(params.f0Km+(cytcdiff))) ...
        *(Hn./Hp) - 4*((params.Vmax*O2)/(params.Km*(1 ...
        +(params.K1/Cytcred))+O2))*(Hn/Hp) + (0.25*heaviside(t - params.fccp_25) ...
        + 0.25*heaviside(t - params.fccp_50) + 0.25*heaviside(t - params.fccp_75) ...
        + 0.25*heaviside(t - params.fccp_100)) * params.Dh * ((Hp - Hn) + Hp * log(Hp/Hn));%dHn
dy(4) = 8*((params.f0Vmax*(cytcdiff))/(params.f0Km+(cytcdiff))) ...
        *(Hn./Hp) + 2*((params.Vmax*O2)/(params.Km*(1 ...
        +(params.K1/Cytcred))+O2))*(Hn/Hp) - (0.25*heaviside(t - params.fccp_25) ...
        + 0.25*heaviside(t - params.fccp_50) + 0.25*heaviside(t - params.fccp_75) ...
        + 0.25*heaviside(t - params.fccp_100)) * params.Dh * ((Hp - Hn) + Hp * log(Hp/Hn)); %dHp
