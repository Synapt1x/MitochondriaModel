...
dy(1) = 2*parameters.f0*((parameters.Vmax*(cytcdiff))/(parameters.Km+(cytcdiff))) ...
        *(Hn./Hp) - 2*((parameters.Vmax*O2)/(parameters.Km*(1 ...
        +(parameters.K1/Cytcred))+O2))*(Hn/Hp); %dCytcred
dy(2) = -0.5*((parameters.Vmax*O2)/(parameters.Km* ...
    (1+(parameters.K1/Cytcred))+O2))*(Hn/Hp); %dO2
dy(3) = -6*parameters.f0*((parameters.Vmax*(cytcdiff))/(parameters.Km+(cytcdiff))) ...
        *(Hn./Hp) - 2*((parameters.Vmax*O2)/(parameters.Km*(1 ...
