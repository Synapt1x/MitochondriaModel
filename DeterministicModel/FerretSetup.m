...
% ====================================
% Parameters (X)
par.X.Vmax.range=[50,5000];
%
par.X.K1.range=[50,500];
%
par.X.Km.range=[10,1000];
%
par.X.p1.range=[1E6,1E9];
%
par.X.p2.range=[50,5000];
%
par.X.p3.range=[1E2,1E6];
%
par.X.f0Vmax.range=[50,1000];
%
par.X.f0Km.range=[1E3,1E5];
%
par.X.Dh.range=[1E-1,50];
%
par.X.cytcred.range=[1E-1,1E2];
%
par.X.cytcox.range=[1E-1,1E2];
%
par.X.oxygen.range=[1E-1,1E4];
%
