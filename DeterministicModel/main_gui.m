...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%This function handles the user interface for the model, which provides a 
%GUI that allows the model to be fully accessible. The user can alter
%parameters and manipulate the model, run additional simulations, and thus
%view how alterations affect the model without having to restart the model.
%
%The instantiation code and object creation code are generated by GUIDE in
%in matlab. The remaining code was written specifically to allow
%functionality in the program and is specific to the model.
%GUIDE was primarily used for the interface, and to lay out elements. All
%Callback functions were programmed manually for use in this model.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[handles.graphs{1:8}] = deal(handles.Cytc_plot,handles.Cytc_rate_plot,...
    handles.O2_plot,handles.OCR_plot,handles.H_N_plot,...
    handles.H_N_rate_plot,handles.H_P_plot,handles.H_P_rate_plot);
...
%plot the Hn rate of appearance over time
plot(handles.H_N_rate_plot,t,gradient(Hn));

%plot the Hp concentration over time
plot(handles.H_P_plot,t,Hp);

%plot the Hp rate of appearance over time
plot(handles.H_P_rate_plot,t,gradient(Hp));
