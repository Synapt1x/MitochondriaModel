...
[handles.allcontEdits{1:9}] = deal(handles.f0Vmax_cedit, ...
    handles.f0Km_cedit, handles.V_max_cedit, handles.K_m_cedit, ...
    handles.K_1_cedit, handles.p1_cedit, handles.p3_cedit, ...
    handles.p2_cedit, handles.p_alpha_cedit);

%store all exp editing text boxes in the handles structure as an array
[handles.allEdits{1:9}] = deal(handles.f0Vmax_edit, ...
    handles.f0Km_edit, handles.V_max_edit, handles.K_m_edit, ...
    handles.K_1_edit, handles.p1_edit, handles.p3_edit, ...
    handles.p2_edit, handles.p_alpha_edit);
...
[hObject, handles] = edit_box(hObject,handles,'control','fIV_Vmax');
guidata(hObject,handles);

function K_1_cedit_Callback(hObject, eventdata, handles)
[hObject, handles] = edit_box(hObject,handles,'control','fIV_Km');
guidata(hObject,handles);

function K_m_cedit_Callback(hObject, eventdata, handles)
[hObject, handles] = edit_box(hObject,handles,'control','fIV_K');
guidata(hObject,handles);

function p1_cedit_Callback(hObject, eventdata, handles)
[hObject, handles] = edit_box(hObject,handles,'control','fV_Vmax');
guidata(hObject,handles);

function p2_cedit_Callback(hObject, eventdata, handles)
[hObject, handles] = edit_box(hObject,handles,'control','fV_Km');
guidata(hObject,handles);

function p3_cedit_Callback(hObject, eventdata, handles)
[hObject, handles] = edit_box(hObject,handles,'control','fV_K');
guidata(hObject,handles);

function f0Vmax_cedit_Callback(hObject, eventdata, handles)
[hObject, handles] = edit_box(hObject,handles,'control','f0_Vmax');
guidata(hObject,handles);
...
[hObject, handles] = edit_box(hObject,handles,'control','alpha');
guidata(hObject,handles);
