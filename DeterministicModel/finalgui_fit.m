...
[handles.allEdits{1:10}] = deal(handles.f0_Vmax_edit, handles.f0_Km_edit, ...
    handles.fIV_Vmax_edit,handles.fIV_Km_edit,handles.fIV_K_edit, ...
    handles.fV_Vmax_edit, handles.fV_Km_edit, handles.fV_K_edit, ...
    handles.p_alpha_edit, handles.p_fccp_edit);
