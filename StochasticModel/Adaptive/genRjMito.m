...
c1=4*(10^-4); % Best value is 5*(10^-4)try to change this parameter up and down 8.5 8.834 *(10^-5). Increases in c1 seem to be lowering species 1 cncentration to negative ranges. 4 *10^-6 
c2=4*(10^-2); % stick with 2.64 *(10^-2)
c3=10^-30; % stick with 10^-30. Higher values slow down the simulation 
c4=1*(10^-9); % decrease this parameter  2*(10^-8)
