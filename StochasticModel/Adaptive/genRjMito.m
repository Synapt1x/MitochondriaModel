...
c1=8.05*(10^-5); % try to change this parameter up and down 8.5 8.834 *(10^-5). Increases in c1 seem to be lowering species 1 cncentration to negative ranges 
c2=2.5*(10^-2); % stick with 2.65 *(10^-2)
c3=10^-30;
