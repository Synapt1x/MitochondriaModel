...
c1=5.5*(10^-6); % try to change this parameter up and down 8.5 8.834 *(10^-5). Increases in c1 seem to be lowering species 1 cncentration to negative ranges 
c2=1.48*(10^-2); % stick with 2.65 *(10^-2)
