...
ajs = [(0.100)*species3/species4...
     (1000)*(2.1236*species2)/((101.2983*(1+(100.1019/species1)))+species2)...
     (0.10)*species4*((p1*(species4/(species3)))/((species4/(species3))+p2+(p3/(species3))))...
     (0.10)*p4*((species4-species3)+(species4*log(species4/(species3))))];
