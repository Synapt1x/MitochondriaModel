...
ajs = [0.0000000001*species5*species7*(species7-1)*(species7-2)*(species7-3)*(1/24)...
     0.00000000001*species2*species1*(species1-1)*(species1-2)*(species1-3)*(1/24)...
     0.000000001*species4*((p1*(species4/(species3)))/((species4/(species3))+p2+(p3/(species3))))...
      0.00000001*p4*((species4-species3)+(species4*log(species4/(species3))))];
