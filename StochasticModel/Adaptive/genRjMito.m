...
ajs = abs([(10^-15)*(f0)*species3/species4...
     ((10^-15)*(vmax*species2)/((km*(1+(k1/species1)))+species2))*(species3/species4)...
     ((10^-16)*species4*((p1*(species4/(species3)))/((species4/(species3))+p2+(p3/(species3)))))...
     ((10^-16)*p4*((species4-species3)+(species4*log(species4/(species3)))))]);
